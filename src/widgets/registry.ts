...
export const WIDGETS: WidgetBlueprint[] = [
  ...
  { type: 'banner', label: 'באנר', icon: Megaphone, create: () => ({ type: 'banner', backgroundImage: 'https://picsum.photos/1200/500', overlayColor: 'rgba(0,0,0,0.5)', heading: '<strong>מבצע!</strong>', text: 'הנחות ענק', ctaLabel: 'לפרטים', buttons: [{ id: '1', label: 'לפרטים', href: '#', variant: 'filled' as const, width: 'auto' as const }], visible: true, style: { minHeight: '360px' }, contentPosition: { horizontal: 'center', vertical: 'center' }, headingStyle: { fontSize: 28, fontWeight: 600, lineHeight: 1, color: '#ffffff' }, textStyle: { fontSize: 16, lineHeight: 1, color: '#ffffff' }, buttonStyle: { background: '#2563eb', color: '#ffffff', borderRadius: 6, fontSize: 16, fontWeight: 500, padding: { top: 8, bottom: 8, left: 16, right: 16 } }, buttonWidth: 'auto', buttonAlign: 'center', buttonVariant: 'filled', buttonsGap: 8 } as any) },
  ...
  { type: 'productSlider', label: 'סליידר מוצרים', icon: ShoppingCart, create: () => ({ 
    type: 'productSlider', 
